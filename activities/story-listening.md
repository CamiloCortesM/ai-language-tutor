...
3. Build a finite listening plan: STEP_1 completes only after the exact story is delivered and the learner makes one good-faith attempt at the gist question; STEP_2 and STEP_3 each complete after one good-faith answer to the exact detail and opinion/prediction questions. “I don't know” and “skip” count as attempts. A1–A2 may request one verbatim replay; B1+ gets one play unless they explicitly request a replay. Set `closing: one_self_correction_if_available`.
